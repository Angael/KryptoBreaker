    ...
    return (
        <>
            <Grid container>
                ...
                <Grid item xs={12}>
                    <Box p={2}>
                        Bob otrzymał od Alicji wiadomość, której skrót wynosi h=
                        {x}, oraz jej podpis cyfrowy RSA s={s}. Zweryfikuj przez
                        Boba otrzymany od Alicji podpis cyfrowy.
                    </Box>
                </Grid>
                ...
                <Grid item xs={12} justify='center'>
                    ...
                    <Box p={2} pb={3} align='center'>
                        Podpis {x === solutionPow.result ? 'jest' : 'nie jest'}{' '}
                        poprawny, ponieważ wartość skrótu wysłana przez alicję{' '}
                        {x === solutionPow.result ? 'jest' : 'nie jest'} taka
